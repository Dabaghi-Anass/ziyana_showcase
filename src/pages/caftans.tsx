  ...
  return (
    <div className="caftans-page">
      {caftans.map((caftan, index) => (
        <section className="caftan-section" key={`${caftan.compition_name}-${index}`}>
          <div className="caftan-image-container">
            <img src={caftan.image_url || "/placeholder.svg"} alt={caftan.compition_name} className="caftan-image" />
            {caftan.isWinner && (
      ...
      {(totalPages > 1 || hasMore) && (
        <div className="pagination-container">
          <button className="pagination-btn" onClick={handlePreviousPage} disabled={currentPage === 0}>
            Previous
          </button>
