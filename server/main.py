...
"6", "Amateurs d’élégance raffinée et de tradition. Sensibles à l’esthétique complexe et au savoir-faire artisanal. Recherchent la beauté intemporelle et l’harmonie visuelle dans ce qui les entoure."
"5","Personnes attirées par l'élégance traditionnelle et l'expression culturelle raffinée. Elles valorisent l'héritage artisanal, la richesse des détails, et le symbolisme des couleurs. Souvent sensibles à l'esthétique authentique et à la beauté intemporelle, elles expriment leur identité à travers des objets de caractère et de profondeur."
"4","Ces personnes recherchent la richesse culturelle et l’expression individuelle à travers les vêtements. Elles sont attirées par la symbolique des couleurs, le souci du détail, et le raffinement. Curieuses et confiantes, elles apprécient l’originalité, le prestige visuel, et les traditions artistiques revisitées avec modernité."
"3","Ces personnes valorisent la subtilité, l’élégance naturelle et le charme minimaliste. Leur sensibilité est tournée vers la sophistication discrète et l’harmonie. Attachées à l’authenticité, elles apprécient les créations qui conjuguent légèreté et raffinement artisanal, souvent avec une affinité pour les marques au style épuré et affirmé."
"1","Personnes passionnées par les symboles culturels et l’expressivité visuelle. Elles aiment se démarquer avec élégance et charisme. Souvent attachées à l’héritage historique, elles expriment une fierté identitaire à travers des pièces majestueuses et méticuleusement ornées. Créatives et affirmées, elles apprécient les atmosphères théâtrales et les détails opulents."
"0","Ces personnes sont sensibles à la mise en valeur de l'identité culturelle à travers des tenues sophistiquées et traditionnelles. Elles apprécient la richesse des matières, les détails lumineux comme l’or, et les mises en scène raffinées. Souvent passionnées par l’art de recevoir, elles aiment la beauté cérémonielle, le sens du rituel et la puissance symbolique des vêtements qui marquent les moments forts de la vie."
"""
API_KEY = os.getenv("API_KEY")
sys_instructions = 'you are a caftan expert, you are able to generate caftan names based on the user description, favorite color, style preference, and occasion. You will use the psychological profiles to generate the caftan name. The user will provide a description of what they want, their favorite color, style preference, and occasion.(do not respond in markdown format) (respond in the language of the user) You will return a 2 comma separated values response of user description of 2 sentences [desc, index] (you pronoun like you are talking to the user) generated by you based on their input (interpret it psychologically) and caftan_index that is unique and creative.here is the list of caftan indexes: ' + psychological_profiles+ 'user prompt: '
